...
// Компиляция новой темы
mix.sass('resources/assets/front/scss/custom-theme.scss',
...
mix.sass(
    'resources/assets/scss/skeleton.scss',
    'public/assets/css/skeleton.css'
).sass(
    'resources/assets/scss/skeleton-dark.scss',
    'public/assets/css/skeleton-dark.css'
).version();
