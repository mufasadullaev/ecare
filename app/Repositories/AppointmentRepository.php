...
class AppointmentRepository extends BaseRepository
{
    ...
    {
        $data = [];
        $appointments = Appointment::with(['patient.user', 'doctor.user', 'services'])->get();
    ...
    public function getDoctorAppointmentsData(): array
    {
            ...
            'line_items' => [[
                'price_data' => [
                    ...
                    'product_data' => [
                        ...
                        'description' => 'Payment for booking appointment with doctor: '.$doctorName->user->full_name.' at '.Carbon::parse($input->date)->format('d/m/Y').' '.$input->from_time.' '.$input->from_time_type.' to '.$input->to_time.' '.$input->to_time_type,
                    ],
